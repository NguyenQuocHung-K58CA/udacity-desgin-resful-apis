...
try:
	...
	h.add_credentials('TinnyTim','Udacity')
	url = address + '/bagels'
	data = dict(username = "TinnyTim", password = "Udacity", name = "plain01", picture = "http://bonacbagel.weebly.com/uploads/4/0/5/4/40548977/s318635836612132814_p1_i1_w240.jpeg", description = "Old-Fash000ioned Plain Bagel", price= "$1.99")
